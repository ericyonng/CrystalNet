...
* mongodb 2C4G 200GB硬盘, 无公网
* LogicServer 2C4G 100GB硬盘 无公网
* Gateway/LoginServer(建议Login和Gate合并一个进程,共享日志等资源) 4C8G 100GB硬盘, 带公网 ，海外机器入流量不计费，出流量收费, 需要设置出流量告警, 避免巨额账单，如果遭受ddos攻击那么ip可能被封禁2-24小时，需要及时切备用机器
* 