...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    ...
    {
      CLOG_ERROR("Encode message SystemLogDataListReq failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    {
        CLOG_ERROR("Decode message SystemLogDataListReq failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message SystemLogDataListRes failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message SystemLogDataListRes failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
