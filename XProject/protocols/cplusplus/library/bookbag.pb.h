...
// AnnotaionInfo[opcode(13), nolog(false), XorEncrypt(false), KeyBase64(false), EnableStorage:(false)]
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    ...
    {
      CLOG_ERROR("Encode message BookBagInfoReq failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    {
        CLOG_ERROR("Decode message BookBagInfoReq failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
// AnnotaionInfo[opcode(14), nolog(false), XorEncrypt(false), KeyBase64(false), EnableStorage:(false)]
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message BookBagInfoNty failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message BookBagInfoNty failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
// AnnotaionInfo[opcode(15), nolog(false), XorEncrypt(false), KeyBase64(false), EnableStorage:(false)]
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message BookBagInfoRes failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message BookBagInfoRes failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
// AnnotaionInfo[opcode(16), nolog(false), XorEncrypt(false), KeyBase64(false), EnableStorage:(false)]
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message SetBookBagInfoReq failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message SetBookBagInfoReq failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
// AnnotaionInfo[opcode(17), nolog(false), XorEncrypt(false), KeyBase64(false), EnableStorage:(false)]
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message SetBookBagInfoRes failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message SetBookBagInfoRes failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
// AnnotaionInfo[opcode(18), nolog(false), XorEncrypt(false), KeyBase64(false), EnableStorage:(false)]
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message SubmitBookBagBorrowInfoReq failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message SubmitBookBagBorrowInfoReq failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
// AnnotaionInfo[opcode(19), nolog(false), XorEncrypt(false), KeyBase64(false), EnableStorage:(false)]
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message SubmitBookBagBorrowInfoRes failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message SubmitBookBagBorrowInfoRes failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
