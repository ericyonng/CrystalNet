...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    ...
    {
      CLOG_ERROR("Encode message CreatureAttrKey failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    {
        CLOG_ERROR("Decode message CreatureAttrKey failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
