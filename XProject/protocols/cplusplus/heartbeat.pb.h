...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    ...
    {
      CLOG_ERROR("Encode message NodeHeartbeatReq failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    {
        CLOG_ERROR("Decode message NodeHeartbeatReq failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message NodeHeartbeatRes failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message NodeHeartbeatRes failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
// AnnotaionInfo[opcode(7), nolog(false), XorEncrypt(false), KeyBase64(false), EnableStorage:(false)]
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message RegisterNodeReq failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message RegisterNodeReq failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
// AnnotaionInfo[opcode(8), nolog(false), XorEncrypt(false), KeyBase64(false), EnableStorage:(false)]
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message RegisterNodeRes failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message RegisterNodeRes failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
// AnnotaionInfo[opcode(9), nolog(false), XorEncrypt(false), KeyBase64(false), EnableStorage:(false)]
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message GetNodeListReq failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message GetNodeListReq failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
// AnnotaionInfo[opcode(10), nolog(false), XorEncrypt(false), KeyBase64(false), EnableStorage:(false)]
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message GetNodeListRes failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message GetNodeListRes failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
// AnnotaionInfo[opcode(11), nolog(true), XorEncrypt(true), KeyBase64(true), EnableStorage:(false)]
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message ClientHeartbeatReq failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message ClientHeartbeatReq failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
// AnnotaionInfo[opcode(12), nolog(true), XorEncrypt(false), KeyBase64(false), EnableStorage:(false)]
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message ClientHeartbeatRes failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message ClientHeartbeatRes failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
