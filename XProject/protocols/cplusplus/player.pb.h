...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    ...
    {
      CLOG_ERROR("Encode message PlayerDataReq failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    {
        CLOG_ERROR("Decode message PlayerDataReq failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message PlayerDataRes failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message PlayerDataRes failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message ModifyPlayerNameReq failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message ModifyPlayerNameReq failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
// AnnotaionInfo[opcode(87), nolog(false), XorEncrypt(false), KeyBase64(false), EnableStorage:(false)]
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message ModifyPlayerNameRes failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message ModifyPlayerNameRes failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
...
// AnnotaionInfo[opcode(88), nolog(false), XorEncrypt(false), KeyBase64(false), EnableStorage:(false)]
...
virtual bool Encode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) const override {
    if (UNLIKELY(!IsInitialized()))
    {
      CLOG_ERROR("Encode message PlayerDataNty failed, error: %s", InitializationErrorString().c_str());
      return false;
    }
...
virtual bool Decode(KERNEL_NS::LibStream<KERNEL_NS::_Build::MT> &stream) override {
    ...
    if (UNLIKELY(!ParseFromArray(stream.GetReadBegin(), static_cast<Int32>(stream.GetReadableSize()))))
    {
        CLOG_ERROR("Decode message PlayerDataNty failed, error: %s", InitializationErrorString().c_str());
        return false;
    }
