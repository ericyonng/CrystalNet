...
SET XPROJ_PATH="%CUR_PATH%..\..\XProject\"
...
:: 生成sln
cd %ROOT_PATH%\tools\premake && win_premake5.exe --file=%ROOT_PATH%tools\premake5_xproject.lua %choose% '' use_kernel_so use_storage

:: sln路径
SET SLN_PATH=%ROOT_PATH%\\build_x\\%choose%\\CrystalNet_%choose%.sln
:: 判断sln文件是否存在
