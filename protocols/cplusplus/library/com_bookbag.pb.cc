...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 8, -1, -1, sizeof(::CRYSTAL_NET::service::BookBagInfo)},
};
...
const char descriptor_table_protodef_com_5fbookbag_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "Count\030\002 \001(\021\"J\n\013BookBagInfo\022;\n\020BookInfoIt"
  "emList\030\001 \003(\0132!.CRYSTAL_NET.service.BookI"
  "nfoItemb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_com_5fbookbag_2eproto = {
    false, false, 175, descriptor_table_protodef_com_5fbookbag_2eproto,
    "com_bookbag.proto",
...
BookInfoItem::BookInfoItem(const BookInfoItem& from)
  ...
  ::memcpy(&_impl_.bookid_, &from._impl_.bookid_,
    ...
    reinterpret_cast<char*>(&_impl_.bookid_)) + sizeof(_impl_.bookcount_));
...
void BookInfoItem::InternalSwap(BookInfoItem* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(BookInfoItem, _impl_.bookcount_)
      + sizeof(BookInfoItem::_impl_.bookcount_)
