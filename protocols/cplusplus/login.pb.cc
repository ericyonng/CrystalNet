...
PROTOBUF_CONSTEXPR LoginFinishReq::LoginFinishReq(
    ::_pbi::ConstantInitialized) {}
struct LoginFinishReqDefaultTypeInternal {
  PROTOBUF_CONSTEXPR LoginFinishReqDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~LoginFinishReqDefaultTypeInternal() {}
  union {
    LoginFinishReq _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 LoginFinishReqDefaultTypeInternal _LoginFinishReq_default_instance_;
PROTOBUF_CONSTEXPR LoginFinishRes::LoginFinishRes(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.errcode_)*/0
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct LoginFinishResDefaultTypeInternal {
  PROTOBUF_CONSTEXPR LoginFinishResDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~LoginFinishResDefaultTypeInternal() {}
  union {
    LoginFinishRes _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 LoginFinishResDefaultTypeInternal _LoginFinishRes_default_instance_;
}  // namespace service
}  // namespace CRYSTAL_NET
static ::_pb::Metadata file_level_metadata_login_2eproto[7];
...
const uint32_t TableStruct_login_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::CRYSTAL_NET::service::LoginFinishReq, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::CRYSTAL_NET::service::LoginFinishRes, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::CRYSTAL_NET::service::LoginFinishRes, _impl_.errcode_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 38, -1, -1, sizeof(::CRYSTAL_NET::service::LoginFinishReq)},
  { 44, -1, -1, sizeof(::CRYSTAL_NET::service::LoginFinishRes)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::CRYSTAL_NET::service::_LoginFinishReq_default_instance_._instance,
  &::CRYSTAL_NET::service::_LoginFinishRes_default_instance_._instance,
};
...
const char descriptor_table_protodef_login_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\024\n\014LogoutReason\030\001 \001(\021\022\n\n\002ip\030\002 \001(\t\"\020\n\016Log"
  "inFinishReq\"!\n\016LoginFinishRes\022\017\n\007ErrCode"
  "\030\001 \001(\021B\003\370\001\001b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_login_2eproto = {
    false, false, 379, descriptor_table_protodef_login_2eproto,
    "login.proto",
    &descriptor_table_login_2eproto_once, descriptor_table_login_2eproto_deps, 2, 7,
...
class LoginFinishReq::_Internal {
 public:
};

LoginFinishReq::LoginFinishReq(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase(arena, is_message_owned) {
  // @@protoc_insertion_point(arena_constructor:CRYSTAL_NET.service.LoginFinishReq)
}
LoginFinishReq::LoginFinishReq(const LoginFinishReq& from)
  : ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase() {
  LoginFinishReq* const _this = this; (void)_this;
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:CRYSTAL_NET.service.LoginFinishReq)
}
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData LoginFinishReq::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl,
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeImpl,
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*LoginFinishReq::GetClassData() const { return &_class_data_; }
...
::PROTOBUF_NAMESPACE_ID::Metadata LoginFinishReq::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_login_2eproto_getter, &descriptor_table_login_2eproto_once,
...
class LoginFinishRes::_Internal {
 public:
};

LoginFinishRes::LoginFinishRes(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:CRYSTAL_NET.service.LoginFinishRes)
}
LoginFinishRes::LoginFinishRes(const LoginFinishRes& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  LoginFinishRes* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.errcode_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  // @@protoc_insertion_point(copy_constructor:CRYSTAL_NET.service.LoginFinishRes)
}

inline void LoginFinishRes::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
LoginFinishRes::~LoginFinishRes() {
  // @@protoc_insertion_point(destructor:CRYSTAL_NET.service.LoginFinishRes)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void LoginFinishRes::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void LoginFinishRes::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void LoginFinishRes::Clear() {
// @@protoc_insertion_point(message_clear_start:CRYSTAL_NET.service.LoginFinishRes)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* LoginFinishRes::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* LoginFinishRes::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:CRYSTAL_NET.service.LoginFinishRes)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:CRYSTAL_NET.service.LoginFinishRes)
  return target;
}

size_t LoginFinishRes::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:CRYSTAL_NET.service.LoginFinishRes)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData LoginFinishRes::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    LoginFinishRes::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*LoginFinishRes::GetClassData() const { return &_class_data_; }


void LoginFinishRes::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<LoginFinishRes*>(&to_msg);
  auto& from = static_cast<const LoginFinishRes&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:CRYSTAL_NET.service.LoginFinishRes)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void LoginFinishRes::CopyFrom(const LoginFinishRes& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:CRYSTAL_NET.service.LoginFinishRes)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool LoginFinishRes::IsInitialized() const {
  return true;
}

void LoginFinishRes::InternalSwap(LoginFinishRes* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_.errcode_, other->_impl_.errcode_);
}

::PROTOBUF_NAMESPACE_ID::Metadata LoginFinishRes::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_login_2eproto_getter, &descriptor_table_login_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::CRYSTAL_NET::service::LoginFinishReq*
Arena::CreateMaybeMessage< ::CRYSTAL_NET::service::LoginFinishReq >(Arena* arena) {
  return Arena::CreateMessageInternal< ::CRYSTAL_NET::service::LoginFinishReq >(arena);
}
template<> PROTOBUF_NOINLINE ::CRYSTAL_NET::service::LoginFinishRes*
Arena::CreateMaybeMessage< ::CRYSTAL_NET::service::LoginFinishRes >(Arena* arena) {
  return Arena::CreateMessageInternal< ::CRYSTAL_NET::service::LoginFinishRes >(arena);
}
