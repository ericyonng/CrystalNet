...
cd %~dp0/tools/protogen/ && protogentool.exe --proto_path=../../protocols/proto --ts_out=../../protocols/ts_out --csharp_out=../../protocols/csharp --cpp_out=../../protocols/cplusplus --base_path=../../ --cpp_protoc=../../tools/protobuf/bin/protoc.exe --force_gen_all=1 --protocols_path=../../protocols/ --google_proto_include_path=../../3rd/protobuf/include/
