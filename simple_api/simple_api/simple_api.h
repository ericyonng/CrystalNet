...
extern SIMPLE_API_EXPORT void SimpleApiPushProfile(Int32 playerId, Int64 nowTime, int messageId, int requestId, Int64 dispatchMs
...
extern SIMPLE_API_EXPORT void SimpleApiPushProfile2(Int32 playerId, Int64 nowTime, int messageId, int requestId, Int64 dispatchMs
, Int64 gwRecvMsgTime, Int64 gwPrepareRpcTime, Int64 gsRecvRpcTime
, Int64 gsDispatchMsgTime, Int64 gsHandledTime);

extern SIMPLE_API_EXPORT void SimpleApiPushProfile3(Int32 playerId, Int64 nowTime, int messageId, int requestId
, Int64 gwRecvMsgTime, Int64 gwPrepareRpcTime, Int64 gsRecvRpcTime
